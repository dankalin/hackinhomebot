...
TOKEN_DEV = '5174178094:AAFyt_MEyHe_VtsL-gYp9Tl-q4Mnxgw_170'
bot = telebot.TeleBot(TOKEN_DEV)
# TOKEN_PROD = '5204051376:AAH94zpZg12D7cO-bJ5qQflNL84WD_PvqxQ'
# bot = telebot.TeleBot(TOKEN_PROD)
# APP_URL = f'https://tgbotstankinn.herokuapp.com//{TOKEN_PROD}'
...
def enter_pin(callback):
    if callback.data == 'Yes':  # если нажата кнопка Да, после вопроса о подтверждении личности, то
        ...
        bot.send_message(callback.message.chat.id,
                         'Подойдите ко входу в новый корпус')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-56.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Поверните налево и пройдите через турникет')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-54.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Пройдите к лифту')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-53.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Поднимитесь на 6 этаж')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-46.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Пройдите прямо и поверните налево')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-48.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Кабинет 0605 будет в конце коридора справа от вас')
        bot.send_photo(callback.message.chat.id,
        ...
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-46.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Пройдите прямо и поверните направо')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-45.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Кабинет 0609 на фото')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-444.jpg', 'rb')))
    elif callback.data == '233':
        bot.send_message(callback.message.chat.id,
                         'Подойдите ко входу в старый корпус и пройдите через турникет')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-34.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Идите правее к лестнице')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-35.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'После того как подниметесь по лестнице, поверните направо')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-36.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Двигайтесь прямо до двери Единого деканата, в конце коридора')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-38.jpg', 'rb')))
        bot.send_photo(callback.message.chat.id,
        ...
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-47.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Пройдите прямо и сразу поверните налево')
        bot.send_photo(callback.message.chat.id,
                       bot.send_photo(callback.message.chat.id, photo=open('photo_2022-05-29_00-20-50.jpg', 'rb')))
        bot.send_message(callback.message.chat.id,
                         'Пройдите прямо и справа будет отдел по расчетам со студентами(0732)')
        bot.send_photo(callback.message.chat.id,
...
@bot.message_handler(commands=['ident'])
def ident(message):
